...
func init() {
	...
	beego.Router("/category/add",&controllers.CategoryAddController{},"get:CategoryAddDis")
	beego.Router("/category/add",&controllers.CategoryAddController{},"post:CategoryAdd")
